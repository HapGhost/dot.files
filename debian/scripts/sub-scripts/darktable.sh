...
sudo aptitude install -t unstable gcc g++ cmake intltool xsltproc libgtk-4-dev libxml2-utils libxml2-dev liblensfun-dev librsvg2-dev libsqlite3-dev libcurl4-gnutls-dev libjpeg-dev libtiff5-dev liblcms2-dev libjson-glib-dev libexiv2-dev libpugixml-dev
...
echo
#Build / Compile
./build.sh --prefix /opt/darktable --build-type Release --install --sudo --  "-D CMAKE_CXX_FLAGS='-march=native -O3'"
